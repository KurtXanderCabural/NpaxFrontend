  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed bottom-8 right-8 w-14 h-14 bg-white rounded-full shadow-lg flex items-center justify-center hover:shadow-xl transition-all duration-300 border-2 border-blue-500 ${
          isOpen ? 'scale-110' : ''
        }`}
      >
      ...
      {/* Chat Window */}
      {isOpen && (
        <div ref={chatWindowRef} className="fixed bottom-24 right-8 w-[320px] h-[400px] bg-white rounded-3xl shadow-2xl flex flex-col z-50 overflow-hidden">
          {/* Header */}
